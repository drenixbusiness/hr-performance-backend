...
| Servis | Limit | Heap | Nega shuncha |
|---|---|---|---|
| user-service | 300m | 140m | Argon2id har loginda xotira ajratadi |
| auth-service | 260m | 120m | token imzolaydi, deyarli hech narsa ajratmaydi |
| notification-service | 260m | 120m | daqiqada bir audit sahifasi |
| performance-service | 380m | 200m | RingCentral'dan bir yo'la 11–20 ming yozuv |
| edge-gateway | 340m | 180m | PDF butunlay xotirada yig'iladi |
| postgres | 160m | | |
| redis | 48m | | |
| **Jami** | **1748m** | | **1.71 GiB** |

Hammasi Dokploy environment'idan o'zgartiriladi: `MEM_GATEWAY`, `HEAP_PERFORMANCE` va hokazo. Faylga tegish shart emas.
...
Optimizatsiyadan keyin ilova **1.75 GiB** limitga sig'adi. Lekin:

| | |
|---|---|
| Ilova (limitlar yig'indisi) | 1748 MiB |
| Dokploy (Node + Traefik + o'z Postgres va Redis'i) | ~500 MiB |
| OS va kernel | ~150 MiB |
| **Jami** | **~2.4 GiB** |
| **Mavjud** | **2.0 GiB** |

**400 MB yetishmaydi.** Bu yerdagi hamma optimizatsiya — siqib chiqarish mumkin bo'lgan maksimum. Undan pastga tushirsam:
...
- 1.75 GiB ilova + 0.65 GiB Dokploy/OS = 2.4 GiB ishlatiladi
- 1.6 GiB zaxira qoladi — PDF yaratish, oylik hisobot, frontend uchun
