...
public class GrpcServerProperties {
    ...
    private String certificate = "/etc/drenix/tls/user-service.crt";
    private String privateKey = "/etc/drenix/tls/user-service.key";
    private String ca = "/etc/drenix/tls/internal-ca.crt";

    /** Certificate common names permitted to call this service. */
    private Set<String> allowedPeers = new LinkedHashSet<>(Set.of("edge-gateway", "auth-service", "notification-service", "performance-service"));
